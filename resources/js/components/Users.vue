      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h5 class="modal-title" v-show="editmode">Update User's data</h5>
          ...
          <form @submit.prevent="editmode ? updateUser() : createUser()">
            ...
            <div class="modal-footer">
              ...
              <button type="button" v-show="editmode" class="btn btn-secondary">Reset</button>
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          this.form
            ...
            .catch(() => {
              Swal.fire("Oops!", "Theres was something wrong.", "error");
              this.$Progress.fail();
            });
        }
      });
